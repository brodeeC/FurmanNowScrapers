DROP TABLE IF EXISTS "athletics" CASCADE;
DROP TABLE IF EXISTS "BusStops" CASCADE;
DROP TABLE IF EXISTS "DHmenu" CASCADE;
DROP TABLE IF EXISTS "FU20_RestaurantHours" CASCADE;
DROP TABLE IF EXISTS "GolfDay" CASCADE;
DROP TABLE IF EXISTS "GolfPlayers" CASCADE;
DROP TABLE IF EXISTS "GolfRounds" CASCADE;
DROP TABLE IF EXISTS "GolfSchedule" CASCADE;
DROP TABLE IF EXISTS "Standups" CASCADE;
DROP TABLE IF EXISTS "TESTtimes" CASCADE;
DROP TABLE IF EXISTS "TestMenu" CASCADE;
DROP TABLE IF EXISTS "TestNulls" CASCADE;
DROP TABLE IF EXISTS "ZToDo" CASCADE;
DROP TABLE IF EXISTS "benches" CASCADE;
DROP TABLE IF EXISTS "buildingHours" CASCADE;
DROP TABLE IF EXISTS "buildingLocations" CASCADE;
DROP TABLE IF EXISTS "clps" CASCADE;
DROP TABLE IF EXISTS "contacts" CASCADE;
DROP TABLE IF EXISTS "foodService" CASCADE;
DROP TABLE IF EXISTS "healthSafety" CASCADE;
DROP TABLE IF EXISTS "importantDates" CASCADE;
DROP TABLE IF EXISTS "importantLinks" CASCADE;
DROP TABLE IF EXISTS "newsContent" CASCADE;
DROP TABLE IF EXISTS "newsPublishers" CASCADE;
DROP TABLE IF EXISTS "parkingResources" CASCADE;
DROP TABLE IF EXISTS "parkingZones" CASCADE;
DROP TABLE IF EXISTS "restaurantMenu" CASCADE;
DROP TABLE IF EXISTS "shuttleLocations" CASCADE;
DROP TABLE IF EXISTS "stopsDistanceTable" CASCADE;
DROP TABLE IF EXISTS "stopsTable" CASCADE;
DROP TABLE IF EXISTS "times" CASCADE;
DROP TABLE IF EXISTS "updateTimes" CASCADE;
DROP TABLE IF EXISTS "userRatings" CASCADE;
DROP TABLE IF EXISTS "vehicleNames" CASCADE;
...
CREATE TABLE IF NOT EXISTS "parkingZones" (
  ...
  "lightPurple" BOOLEAN NOT NULL DEFAULT FALSE,
  public_col BOOLEAN NOT NULL DEFAULT FALSE
);
...
CREATE INDEX IF NOT EXISTS idx_dhmenu_itemid ON "DHmenu"("itemID");

...
DROP TABLE IF EXISTS "DHmenu";
DROP TABLE IF EXISTS "FU20_RestaurantHours";
DROP TABLE IF EXISTS "GolfDay";
DROP TABLE IF EXISTS "GolfPlayers";
DROP TABLE IF EXISTS "GolfRounds";
DROP TABLE IF EXISTS "GolfSchedule";
DROP TABLE IF EXISTS "Standups";
DROP TABLE IF EXISTS "TESTtimes";
DROP TABLE IF EXISTS "TestMenu";
DROP TABLE IF EXISTS "TestNulls";
DROP TABLE IF EXISTS "ZToDo";
DROP TABLE IF EXISTS "benches";
DROP TABLE IF EXISTS "buildingHours";
DROP TABLE IF EXISTS "buildingLocations";
DROP TABLE IF EXISTS "clps";
DROP TABLE IF EXISTS "contacts";
DROP TABLE IF EXISTS "foodService";
DROP TABLE IF EXISTS "healthSafety";
DROP TABLE IF EXISTS "importantDates";
DROP TABLE IF EXISTS "importantLinks";
DROP TABLE IF EXISTS "newsContent";
DROP TABLE IF EXISTS "newsPublishers";
DROP TABLE IF EXISTS "parkingResources";
DROP TABLE IF EXISTS "parkingZones";
DROP TABLE IF EXISTS "restaurantMenu";
DROP TABLE IF EXISTS "shuttleLocations";
DROP TABLE IF EXISTS "stopsDistanceTable";
DROP TABLE IF EXISTS "stopsTable";
DROP TABLE IF EXISTS "times";
DROP TABLE IF EXISTS "updateTimes";
DROP TABLE IF EXISTS "userRatings";
DROP TABLE IF EXISTS "vehicleNames";
